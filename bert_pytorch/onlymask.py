...
from trainer import BERTTrainer , BERTTrainer_embed
...
def train():
    ...
    parser.add_argument("-restart_epoch","--restart_epoch", type=int, default=0, help="restart epoch")
    ...
    trainer = BERTTrainer_embed(bert, len(vocab), train_dataloader=train_data_loader, test_dataloader=test_data_loader,
